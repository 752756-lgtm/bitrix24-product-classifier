...
class PrepareActivityWorkflow2026Tests(unittest.TestCase):
    ...
    def test_stable_workflow_is_manual_only_with_direct_inputs(self):
        ...
        self.assertNotIn("33657165406", self.workflow)
        self.assertNotIn("54dec3c579c9906ea0d2849f1bfcdcbe7a16bf8f", self.workflow)
        self.assertNotIn(
            "33657165406:54dec3c579c9906ea0d2849f1bfcdcbe7a16bf8f:"
            "500:996:1:true:false",
            self.workflow,
        )
