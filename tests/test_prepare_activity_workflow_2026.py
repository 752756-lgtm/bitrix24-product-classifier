...
class PrepareActivityWorkflow2026Tests(unittest.TestCase):
    ...
    def test_stable_workflow_is_manual_only_with_direct_inputs(self):
        ...
        self.assertNotIn("33669036454", self.workflow)
        self.assertNotIn("f4b5c2bca80e9534ab8c12c25ba494f26b62cabe", self.workflow)
        self.assertNotIn(
            "33669036454:f4b5c2bca80e9534ab8c12c25ba494f26b62cabe:"
            "500:1992:1:true:false",
            self.workflow,
        )
