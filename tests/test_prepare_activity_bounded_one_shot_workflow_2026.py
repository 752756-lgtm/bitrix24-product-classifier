...
MARKER_RELATIVE = Path(
    ...
    "prepare-activity-plan-2026-bounded-500-skip-1992-deterministic-slice-5.trigger"
)
MARKER_PATH = ROOT / MARKER_RELATIVE
MARKER_SHA256 = "46c4257bb10a9aa12f7d51b06ec2da6017c48d3b7eb0c878688e7d164f61f156"
...
class PrepareActivityBoundedOneShotWorkflow2026Tests(unittest.TestCase):
    ...
    def test_marker_payload_and_hash_are_byte_exact(self):
        self.assertEqual(
            ...
            b"writer_run_id=33669036454\n"
            b"max_deals=500\n"
            b"skip_remaining=1992\n"
            b"model_workers=1\n"
    ...
    def test_push_has_fixed_slice_inputs_and_manual_inputs_are_preserved(self):
        ...
        for expected in (
            "EXPECTED_WRITER_RUN_ID: ${{ github.event_name == 'push' && '33669036454' || inputs.writer_run_id }}",
            "EXPECTED_WRITER_HEAD_SHA: ${{ github.event_name == 'push' && 'f4b5c2bca80e9534ab8c12c25ba494f26b62cabe' || '' }}",
            "MAX_DEALS: ${{ github.event_name == 'push' && '500' || inputs.max_deals }}",
            "SKIP_REMAINING: ${{ github.event_name == 'push' && '1992' || inputs.skip_remaining }}",
            ...
            '"33669036454:f4b5c2bca80e9534ab8c12c25ba494f26b62cabe:500:1992:1:true:false"',
            '--max-deals "${MAX_DEALS}"',
