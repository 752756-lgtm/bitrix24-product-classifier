...
MARKER_SHA256 = "fa693641f4116384c600ffd7d7ae48ee844bb981671624c29a5898304780096b"
...
class PrepareActivityBoundedOneShotWorkflow2026Tests(unittest.TestCase):
    ...
    def test_marker_payload_and_hash_are_byte_exact(self):
        self.assertEqual(
            ...
            b"writer_run_id=33663228256\n"
            b"max_deals=500\n"
            b"skip_remaining=1494\n"
            b"model_workers=1\n"
    ...
    def test_push_has_fixed_slice_inputs_and_manual_inputs_are_preserved(self):
        ...
        for expected in (
            "EXPECTED_WRITER_RUN_ID: ${{ github.event_name == 'push' && '33663228256' || inputs.writer_run_id }}",
            "EXPECTED_WRITER_HEAD_SHA: ${{ github.event_name == 'push' && '3bd637ee93dce17a2fa9041450a6bd4c3d1a5368' || '' }}",
            "MAX_DEALS: ${{ github.event_name == 'push' && '500' || inputs.max_deals }}",
            "SKIP_REMAINING: ${{ github.event_name == 'push' && '1494' || inputs.skip_remaining }}",
            ...
            '"33663228256:3bd637ee93dce17a2fa9041450a6bd4c3d1a5368:500:1494:1:true:false"',
            '--max-deals "${MAX_DEALS}"',
