...
MARKER_RELATIVE = Path(
    ...
    "prepare-activity-plan-2025-bounded-500-skip-1182.trigger"
)
MARKER_PATH = ROOT / MARKER_RELATIVE
MARKER_SHA256 = "9a100826a8dc787c612f1de54a2f28c2bcf7c00c607c1b2f4fcb1c9766920e94"
...
class PrepareActivityBoundedOneShotWorkflowTests(unittest.TestCase):
    ...
    def test_push_has_fixed_bounded_inputs_and_manual_inputs_are_preserved(self):
        ...
        for expected in (
            ...
            "SKIP_REMAINING: ${{ github.event_name == 'push' && '1182' || inputs.skip_remaining }}",
