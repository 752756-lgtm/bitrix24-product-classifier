...
MARKER_RELATIVE = Path(
    ...
    "prepare-activity-plan-2025-bounded-500-skip-1657.trigger"
)
MARKER_PATH = ROOT / MARKER_RELATIVE
MARKER_SHA256 = "5b922beec02ac242380038698dc6a0160b384f72bcbe5091e85e424f5b733bfb"
...
class PrepareActivityBoundedOneShotWorkflowTests(unittest.TestCase):
    ...
    def test_push_has_fixed_bounded_inputs_and_manual_inputs_are_preserved(self):
        ...
        for expected in (
            ...
            "SKIP_REMAINING: ${{ github.event_name == 'push' && '1657' || inputs.skip_remaining }}",
