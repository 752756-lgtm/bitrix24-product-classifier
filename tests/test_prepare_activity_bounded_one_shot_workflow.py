...
MARKER_RELATIVE = Path(
    ...
    "prepare-activity-plan-2025-bounded-500-skip-2117.trigger"
)
MARKER_PATH = ROOT / MARKER_RELATIVE
MARKER_SHA256 = "6a6bf3c69117097f32b7af848ae5f1cebe5d2836a190ecafa06529130c3ea71b"
...
class PrepareActivityBoundedOneShotWorkflowTests(unittest.TestCase):
    ...
    def test_push_has_fixed_bounded_inputs_and_manual_inputs_are_preserved(self):
        ...
        for expected in (
            ...
            "SKIP_REMAINING: ${{ github.event_name == 'push' && '2117' || inputs.skip_remaining }}",
