...
MARKER_RELATIVE = Path(
    ...
    "prepare-activity-plan-2025-bounded-500-skip-725.trigger"
)
MARKER_PATH = ROOT / MARKER_RELATIVE
MARKER_SHA256 = "8cfc861118844a32bb044ea966707376379801b19e5d2c16cc38957c72085a35"
...
class PrepareActivityBoundedOneShotWorkflowTests(unittest.TestCase):
    ...
    def test_push_has_fixed_bounded_inputs_and_manual_inputs_are_preserved(self):
        ...
        for expected in (
            ...
            "SKIP_REMAINING: ${{ github.event_name == 'push' && '725' || inputs.skip_remaining }}",
