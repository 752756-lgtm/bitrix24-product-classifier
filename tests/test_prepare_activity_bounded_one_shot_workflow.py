...
MARKER_RELATIVE = Path(
    ...
    "prepare-activity-plan-2025-bounded-250-skip-480.trigger"
)
MARKER_PATH = ROOT / MARKER_RELATIVE
MARKER_SHA256 = "d9842903c768332caba552197aa8ccc6c7338a5975e57964dd262db6657b4363"
...
class PrepareActivityBoundedOneShotWorkflowTests(unittest.TestCase):
    ...
    def test_push_has_fixed_bounded_inputs_and_manual_inputs_are_preserved(self):
        ...
        for expected in (
            ...
            "SKIP_REMAINING: ${{ github.event_name == 'push' && '480' || inputs.skip_remaining }}",
